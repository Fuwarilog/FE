...
export default function Mypage() {
  ...
  if (!userInfo) {
    return <p className="p-8 text-red-500">사용자 정보를 불러올 수 없습니다.</p>;
  }
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center gap-4">
        ...
        />
        <div>
          <p className="text-lg font-medium">이름: {userInfo.name}</p>
          <p className="text-sm text-gray-600">이메일: {userInfo.email}</p>
        </div>
      </div>
    </div>
  );
